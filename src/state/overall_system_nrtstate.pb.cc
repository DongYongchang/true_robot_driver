...
const uint32_t TableStruct_overall_5fsystem_5fnrtstate_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::system_nrtstate::Model, _impl_.is_using_sp_),
  PROTOBUF_FIELD_OFFSET(::system_nrtstate::Model, _impl_.is_collision_detection_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::system_nrtstate::SystemNrtState, _impl_.system_is_init_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 91, -1, -1, sizeof(::system_nrtstate::Subsystem)},
  { 100, -1, -1, sizeof(::system_nrtstate::Sensor)},
  { 109, -1, -1, sizeof(::system_nrtstate::Interface)},
  { 118, -1, -1, sizeof(::system_nrtstate::SystemNrtState)},
};
...
const char descriptor_table_protodef_overall_5fsystem_5fnrtstate_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "t\030\004 \003(\001\022\023\n\013jointtarget\030\005 \003(\001\"\253\002\n\005Model\022\022"
  ...
  "_points\030\010 \003(\0132\026.system_nrtstate.Point\022\023\n"
  "\013is_using_sp\030\t \001(\010\022\036\n\026is_collision_detec"
  "tion\030\n \001(\010\">\n\tSubsystem\022\026\n\016subsystem_nam"
  "e\030\001 \001(\t\022\n\n\002id\030\002 \001(\005\022\r\n\005state\030\003 \001(\005\"8\n\006Se"
  "nsor\022\023\n\013sensor_name\030\001 \001(\t\022\n\n\002id\030\002 \001(\005\022\r\n"
  "\005state\030\003 \001(\005\">\n\tInterface\022\026\n\016interface_n"
  "ame\030\001 \001(\t\022\n\n\002id\030\002 \001(\005\022\r\n\005state\030\003 \001(\005\"\314\002\n"
  "\016SystemNrtState\022%\n\004head\030\001 \001(\0132\027.system_n"
  "rtstate.Header\022\034\n\024system_running_state\030\002"
  " \001(\010\022%\n\005model\030\003 \003(\0132\026.system_nrtstate.Mo"
  "del\022/\n\ncontroller\030\004 \001(\0132\033.system_nrtstat"
  "e.Controller\022-\n\tsubsystem\030\005 \003(\0132\032.system"
  "_nrtstate.Subsystem\022\'\n\006sensor\030\006 \003(\0132\027.sy"
  "stem_nrtstate.Sensor\022-\n\tinterface\030\007 \003(\0132"
  "\032.system_nrtstate.Interface\022\026\n\016system_is"
  "_init\030\010 \001(\010b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_overall_5fsystem_5fnrtstate_2eproto = {
    false, false, 1539, descriptor_table_protodef_overall_5fsystem_5fnrtstate_2eproto,
...
Model::Model(const Model& from)
  ...
  ::memcpy(&_impl_.is_using_sp_, &from._impl_.is_using_sp_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.is_collision_detection_) -
    reinterpret_cast<char*>(&_impl_.is_using_sp_)) + sizeof(_impl_.is_collision_detection_));
...
// @@protoc_insertion_point(message_clear_start:system_nrtstate.Model)
  ...
  ::memset(&_impl_.is_using_sp_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.is_collision_detection_) -
      reinterpret_cast<char*>(&_impl_.is_using_sp_)) + sizeof(_impl_.is_collision_detection_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 72)) {
          ...
          goto handle_unusual;
        continue;
      // bool is_collision_detection = 10;
      case 10:
...
uint8_t* Model::_InternalSerialize(
  ...
  if (this->_internal_is_using_sp() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(9, this->_internal_is_using_sp(), target);
  }

  // bool is_collision_detection = 10;
  if (this->_internal_is_collision_detection() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(10, this->_internal_is_collision_detection(), target);
  }
...
void Model::InternalSwap(Model* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Model, _impl_.is_collision_detection_)
      + sizeof(Model::_impl_.is_collision_detection_)
...
uint8_t* SystemNrtState::_InternalSerialize(
  ...
  if (this->_internal_system_is_init() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(8, this->_internal_system_is_init(), target);
  }
